...
# ax3 = fig.add_axes([0.05, 0.55, 0.25, 0.3])
...
# ax3.set_xticklabels(names.values(), rotation=45, fontsize=6)
# ax3.set_yticklabels(names.values(), fontsize=6)
...
# labels (small font)
ax3.set_xticklabels(class_names, rotation=45, fontsize=6)
ax3.set_yticklabels(class_names, fontsize=6)
